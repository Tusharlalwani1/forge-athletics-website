// TODO(Module 9): real transformation entries require explicit written
// member consent before publishing (SRS Section 3.6, FR-6.2) — this is a
// staff/legal process, not just a technical one. This placeholder data
// exists to build and test the UI only.
